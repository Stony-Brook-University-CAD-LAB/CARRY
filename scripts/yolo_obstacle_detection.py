...
def main():
    ...
    def update():
        ...
        depth_panel = render_depth_panel(
            depth_mm,
            zones,
            decision
        )
        ...
        if zones[1] <= DIST_DANGER_SCREEN_M:
            combined = render_full_screen_danger(
                combined,
                zones[1]
            )
